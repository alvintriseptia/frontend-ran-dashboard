	...
	>
		...
		<section class="overflow-auto">
			<table
				...
				:class="{
					'min-h-[300px]':
						searchActivity.length >= 2 && searchData.length === 0,
				}"
			>
				...
				<tbody v-else>
					...
					>
						...
						<td
							v-else-if="
								row.newData.namaSubprogram === row.oldData.namaSubprogram
							"
							class="text-xs text-gray-900 p-2 whitespace-nowrap border-r"
						>
							{{ row.oldData.namaSubprogram }}
						...
						<td
							v-else-if="
								row.newData.additionalInfo === row.oldData.additionalInfo
							"
							class="text-xs text-gray-900 p-2 whitespace-nowrap border-r"
						>
							{{ row.oldData.additionalInfo }}
						...
						<td
							v-else-if="
								row.newData.targetQuartal === row.oldData.targetQuartal
							"
							class="text-xs text-gray-900 p-2 whitespace-nowrap border-r"
						>
							{{ row.oldData.targetQuartal }}
